...
use App\System\Request\SystemConfigGroupRequest;
use Qbhy\HyperfAuth\Annotation\Auth;

#[Controller(prefix: 'system/configGroup'), Auth]
class ConfigGroupController extends AbstractController
{
    ...
    /**
     * 新增
     * @param SystemConfigGroupRequest $request
     * @return ResponseInterface
     */
    #[PostMapping("save"), Scene(scene: 'save')]
    public function save(SystemConfigGroupRequest $request): ResponseInterface
    {
    ...
    public function update(int $id, SystemConfigGroupRequest $request): ResponseInterface
    {
